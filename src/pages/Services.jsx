...
className='w-full h-[130vh] bg-[#004d2eb3] mt-[150px] overflow-hidden items-center max-lg:h-auto'>
  <h2 className='text-center font-bold text-[3rem] mt-[10px] text-[white]'>Our Service</h2>
<div className='grid grid-cols-3 text-center gap-y-[100px] mt-[80px] ml-[100px] max-lg:grid-cols-1 max-lg:ml-[20px] '>
